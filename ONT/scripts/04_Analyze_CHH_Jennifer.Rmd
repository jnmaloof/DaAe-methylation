...
```{r}
L121 <- readGeneric("../output/L121_ONT_to_DaAe_2024-27-04chh.bed.gz",
...
```{r}
T26 <- readGeneric("../output/T26_ONT_to_DaAe_2024-27-04chh.bed.gz",
...
```{r}
DaAe <- readGeneric("../output/DaAe_ONT_to_DaAe_2024-27-04chh.bed"   ,
...
modkit pileup --include-bed ../input/include.bed --log-filepath DaAe-2024-24-04.log --threads 7 --only-tabs "/media/volume/julin_DaAe/NewDaAe_2023_2024/ONT/methylation/PROM0168_Michelmore_NB-Pool_12072023/barcode17_5mc-5hmc_sort.bam" DaAe_ONT_to_DaAe_2024chh.bed --motif CHH 0 --ref "/media/volume/julin-analyses/ref_genomes/B_napus/John_DaAe/DaAe_20210520.fa"  


# L121 to DaAe
modkit pileup --include-bed ../input/include.bed --log-filepath L121-2024-27-04.log --threads 7 --only-tabs "/media/volume/julin_DaAe/NewDaAe_2023_2024/ONT/methylation/PROM0168_Michelmore_NB-Pool_12072023/barcode17_5mc-5hmc_sort.bam" L121_ONT_to_DaAe_2024-27-04chh.bed --motif CHH 0 --ref "/media/volume/julin-analyses/ref_genomes/B_napus/John_DaAe/DaAe_20210520.fa"  


# T26 to DaAe
modkit pileup --include-bed ../input/include.bed --log-filepath T26-2024-27-04.log --threads 7 --only-tabs "/media/volume/julin_DaAe/NewDaAe_2023_2024/ONT/methylation/PROM0168_Michelmore_NB-Pool_12072023/barcode17_5mc-5hmc_sort.bam" --motif CHH 0 --ref "/media/volume/julin-analyses/ref_genomes/B_napus/John_DaAe/DaAe_20210520.fa"  
