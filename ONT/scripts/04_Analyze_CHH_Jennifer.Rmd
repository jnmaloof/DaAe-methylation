...
```{r}
L121 <- readGeneric("~/data/methylation/ONT/output/L121_ONT_to_DaAe.bed.gz"
                    "~/data/methylation/ONT/output/L121_ONT_to_DaAe_chh.bed",
                    meta.cols=list(L121_score=5,
                                   L121_coverage=10))
...
```{r}
T26 <- readGeneric("~/data/methylation/ONT/output/T26_ONT_to_DaAe.bed.gz"
              "~/data/methylation/ONT/output/T26_ONT_to_DaAe_chh.bed",
                    meta.cols=list(T26_score=5,
                                   T26_coverage=10))
...
```{r}
DaAe <- readGeneric("~/data/methylation/ONT/output/DaAe_ONT_to_DaAe.bed"
                    "~/data/methylation/ONT/output/L121_ONT_to_DaAe_chh.bed",
                    meta.cols=list(DaAe_score=5,
                                   DaAe_coverage=10))
...
--motif CH 0 \
--ref $ref \
--include -bed path/to/my_chh.bed > DaAe_ONT_to_DaAe_chh.bed
...
--motif CH 0 \
--ref $ref \
--include -bed path/to/my_chh.bed > L121_ONT_to_DaAe_chh.bed
...
--motif CH 0 \
--ref $ref \
--include -bed path/to/my_chh.bed > T26_ONT_to_DaAe_chh.bed
